...
<html lang="en">
  ...
  <body>
    ...
    <div class="d-flex mt-4">
      <?php $currentPage = 'listar-clientes'; ?>
      ...
      <div class="page-content">
        <div class="container py-5 mb-5 px-md-5">
          <div class="d-flex justify-content-between align-items-center flex-wrap mt-2">
            ...
            <a class="btn btn-primary mt-3" href="cadastrar-cliente.html">
            ...
            <table class="table border bg-white shadow-sm overflow-hidden">
              ...
              <tbody>
                <tr>
                  ...
                  <td>ggiovanasophiaporto@catsfeelings.com.br</td>
                  <td>
                  ...
                  <td>
                    <button class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#clienteModal">
                ...
                <tr>
                  ...
                  <td>ccaiootaviobarros@petrobras.com.br</td>
                  <td>
                    <div class="d-flex align-items-baseline">
                      <i class="fas fa-phone text-muted"></i>
                      <span class="ml-2">(98) 2812-6567</span>
                ...
                <tr>
                  ...
                  <td>thomasruanporto__thomasruanporto@riscao.com.br</td>
                  <td>
                    <div class="d-flex align-items-baseline">
                      <i class="fas fa-phone text-muted"></i>
                      <span class="ml-2">(98) 2812-6567</span>
            ...
            <div class="py-3">
              <div class="row">
                ...
                <div class="col-md-8">
                  ...
                  <div>
                    <span class="font-weight-medium">Genêro: </span>
                    <span>Teste</span>
                  </div>
                  <div>
                  ...
                  <div>
                    <span class="font-weight-medium">Profissão: </span>
                    <span>Teste</span>
                  </div>
                </div>
              </div>
